        ...
        <div class="app-error">
            ...
            <div class="error-action d-flex justify-content-around mt-xxl">
                <a href="<?php echo e(route('home')); ?>" type="button" class="btn btn-opacity btn-primary btn-sm mr-0"> Back to
                    Dashboard </a>
                <a href="<?php echo e(route('question_answer')); ?>" type="button" class="btn btn-opacity btn-danger btn-sm"> Set Secret</a>
            </div>
        </div>
    </div>
</body>
<?php /**PATH /Users/chukwuemekainya/Sites/ibank/resources/views/layouts/set_secret.blade.php ENDPATH**/ ?>