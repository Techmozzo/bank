...
<div class="section-left">
    <div class="section-left-content">
        ...
        <a href="<?php echo e(route('register')); ?>" type="button" class="btn btn-raised btn-raised-warning">Sign
            Up</a>
    </div>
</div>
<div class="form-holder signin-2 px-xxl">
    <div data-perfect-scrollbar='' data-suppress-scroll-x='true'>
        <div class="d-flex flex-column align-items-center mt-lg mb-xxl">
            <a href="<?php echo e(route('register')); ?>"><img class="card-img-top signup" src="/dashboard/dist/assets/images/logo.svg" style="height: 100px" alt="Bank Logo"></a>
