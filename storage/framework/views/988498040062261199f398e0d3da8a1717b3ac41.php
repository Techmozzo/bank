                    ...
                    <div class="card-body">
                        ...
                        <?php if($chequeRequests->count() > 0): ?>
                            <table class="table nowrap" id="datatableScrollXY" style="width:100%">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $chequeRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" class="btn btn-opacity btn-primary btn-sm my-sm mr-sm"
                                                    href="<?php echo e(url('/admin/cheque-requests/'.$hashIds->encode($request->id))); ?>"
                                                    title="Edit Request">Edit</a>
                                                &nbsp;
                                                <button type="button"
                                                    class="btn btn-opacity btn-danger btn-sm my-sm mr-sm delete-item"
                                                    data-id="<?php echo e($hashIds->encode($request->id)); ?>"
