...
@section('custom_content')
    ...
    <div class="container my-lg d-flex flex-column">
        <div class="card-header d-flex jusitify-space-between">
            <h2 class="p-1 m-0 text-16 font-weight-semi">Add Auditor</h2>
            <div class="flex-grow-1"></div>
            <div>
                <a type="button" class="btn btn-opacity btn-primary btn-sm my-sm mr-sm" href="{{route('auditors.index')}}"
                    title="Back">Back</a>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                ...
                <form action="{{ route('auditors.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name" value="{{old('first_name')}}" />
                        @error('first_name')
